// Create this file: src/app/blogs/page.js (not src/app/blogs/[blog]/page.js)
...
export default async function BlogsHomepage() {
  try {
    ...
    console.error('Error loading blogs homepage:', error);
    return (
      <div className="min-h-screen flex items-center justify-center">
        <div className="text-center">
...
export async function generateMetadata() {
  try {
    ...
    console.error('Error generating blogs homepage metadata:', error);
    return {
      title: 'DroidBiz - Programming Tutorials',
      description: 'Learn programming with comprehensive tutorials and examples.',
      keywords: 'programming, tutorials, kotlin, android development',
